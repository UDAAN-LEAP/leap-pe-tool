...
int main(int argc, char *argv[])
{
    ...
    ts << endl << "OpenOCRCorrect Application Log" << endl << "Date: " <<  QDateTime::currentDateTime().toString( "dd MMM yyyy @ HH:mm:ss" ) << endl << "User : " << QString("Username:" + qgetenv("USERNAME")) << endl << "Application Log:" <<endl << endl << endl ;
    ts.setCodec("UTF-8");
    logFile.flush();
    logFile.close();
