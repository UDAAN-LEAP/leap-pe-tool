...
public:
    ...
    void setupUi(QDialog *globalReplaceInformation)
    {
        ...
        globalReplaceInformation->resize(981, 329);
        globalReplaceInformation->setMaximumSize(QSize(981, 329));
...
""));
    ...
    void retranslateUi(QDialog *globalReplaceInformation)
    {
        ...
        ___qtablewidgetitem7->setText(QApplication::translate("globalReplaceInformation", "New Row", Q_NULLPTR));

        const bool __sortingEnabled = tableWidget->isSortingEnabled();
        tableWidget->setSortingEnabled(false);
        QTableWidgetItem *___qtablewidgetitem8 = tableWidget->item(0, 0);
        ___qtablewidgetitem8->setText(QApplication::translate("globalReplaceInformation", "Global replacement", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidget->item(0, 1);
        ___qtablewidgetitem9->setText(QApplication::translate("globalReplaceInformation", "The words which need to be replaced throughout the whole file can be changed with this option.", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem10 = tableWidget->item(1, 0);
        ___qtablewidgetitem10->setText(QApplication::translate("globalReplaceInformation", "Original Words", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem11 = tableWidget->item(1, 1);
        ___qtablewidgetitem11->setText(QApplication::translate("globalReplaceInformation", "The words which are originally translated by the tool", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem12 = tableWidget->item(2, 0);
        ___qtablewidgetitem12->setText(QApplication::translate("globalReplaceInformation", "Replaced Words", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem13 = tableWidget->item(2, 1);
        ___qtablewidgetitem13->setText(QApplication::translate("globalReplaceInformation", "The words which are corrected by the user.", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem14 = tableWidget->item(3, 0);
        ___qtablewidgetitem14->setText(QApplication::translate("globalReplaceInformation", "Replace in all pages", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem15 = tableWidget->item(3, 1);
        ___qtablewidgetitem15->setText(QApplication::translate("globalReplaceInformation", "Checking these tick box will replace the words in already edited pages also.", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem16 = tableWidget->item(4, 0);
        ___qtablewidgetitem16->setText(QApplication::translate("globalReplaceInformation", "Preview", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem17 = tableWidget->item(4, 1);
        ___qtablewidgetitem17->setText(QApplication::translate("globalReplaceInformation", "Click the preview button to see how the changes will reflect in the document.", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem18 = tableWidget->item(5, 0);
        ___qtablewidgetitem18->setText(QApplication::translate("globalReplaceInformation", "Save and Replace", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem19 = tableWidget->item(5, 1);
        ___qtablewidgetitem19->setText(QApplication::translate("globalReplaceInformation", "Click the button to save and replace the changes made.", Q_NULLPTR));
