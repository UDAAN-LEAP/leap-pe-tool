 ...
 * \param a
 * \param b
 * \return editDistance between two strings
...
/*!
 * \fn edit_Distance::matchPattern
 * \brief Returns the match result between two strings
 * \param str1
 * \param arLengthLeft
 * \param str2
 * \param arLengthRight
 ...
 * \param string1
 * \param string2
 * \return Dice match result between two strings
 */
