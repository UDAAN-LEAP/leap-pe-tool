...
void newTextBrowser::setCompleter(QCompleter *completer)
{
    if (c)
        c->disconnect(this);
    ...
    QObject::connect(c, QOverload<const QString &>::of(&QCompleter::activated),
                     this, &newTextBrowser::insertCompletion);
}
//! [2]
...
QString newTextBrowser::textUnderCursor() const
{
    QTextCursor tc = textCursor();
...
void newTextBrowser::focusInEvent(QFocusEvent *e)
{
    if (c)
        c->setWidget(this);
...
void newTextBrowser::keyPressEvent(QKeyEvent *e)
{
