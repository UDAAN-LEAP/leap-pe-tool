...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../lib/quazip-0.7.3/quazip/release/ -lquazip
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../lib/quazip-0.7.3/quazip/debug/ -lquazip
else:unix: LIBS += -L$$PWD/../lib/quazip-0.7.3/quazip/ -lquazip

INCLUDEPATH += $$PWD/../lib/quazip-0.7.3/quazip
DEPENDPATH += $$PWD/../lib/quazip-0.7.3/quazip
