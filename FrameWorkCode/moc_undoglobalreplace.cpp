...
void UndoGlobalReplace::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UndoGlobalReplace *_t = static_cast<UndoGlobalReplace *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject UndoGlobalReplace::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_UndoGlobalReplace.data,
      qt_meta_data_UndoGlobalReplace,  qt_static_metacall, nullptr, nullptr}
};
