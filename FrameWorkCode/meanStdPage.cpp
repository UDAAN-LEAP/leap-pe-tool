...
while(ssCPage >> localstr) {vCPage.push_back(slnp.toslp1(localstr)); /*cout << localstr << endl;*/ }} else return 0; ssCPage.close();
...
if (ssIPage.is_open()){
        ...
        while(ssIPage >> localstr){ localstr = slnp.toslp1(localstr);
