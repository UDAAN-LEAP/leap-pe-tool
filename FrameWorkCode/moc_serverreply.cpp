...
struct qt_meta_stringdata_SimpleMail__ServerReply_t {
    QByteArrayData data[3];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SimpleMail__ServerReply_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SimpleMail__ServerReply_t qt_meta_stringdata_SimpleMail__ServerReply = {
    {
QT_MOC_LITERAL(0, 0, 23), // "SimpleMail::ServerReply"
QT_MOC_LITERAL(1, 24, 8), // "finished"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "SimpleMail::ServerReply\0finished\0"
};
...
void *SimpleMail::ServerReply::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_SimpleMail__ServerReply.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int SimpleMail::ServerReply::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void SimpleMail::ServerReply::finished()
{
